...
These two classes are the building blocks for the BST,
AVLTree, and Heap data structures.
It is crucial to get these implemented correctly in order
to be able to implement the other data structures.
'''
...
class BinaryTree():
    ...
    def __init__(self, root=None):
        ...
        Note that for an ordinary BinaryTree, we cannot insert
        more than one element in the constructor,
    ...
    def print_tree(self, traversal_type):
        ...
        a reference on how to write recursive functions
    ...
    def to_list(self, traversal_type):
        ...
        if traversal_type == 'postorder':
            ...
            return ValueError('Traversal Type ' + str(traversal_type) + 'is not supported.')
